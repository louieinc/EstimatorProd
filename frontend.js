...
(function($) {
    ...
    Fpe.calculate = function() {
        ...
        $('#fpe .totals .subtotal').text('$'+(Math.round(subtotal*100)/100));
        $('#fpe .totals .total').text('$'+(Math.round(total*100)/100));
    }
    ...
    Fpe.putTotal = function(args) {
        ...
        if (typeof args.value != 'undefined') {
            args.el.append('<p class="'+(bold ? 'em' : '')+'"><span>'+Math.round(args.value*100)/100+'</span> '+args.text+'</p>');
        } else {
