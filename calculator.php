...
<div id="fpe">
    ...
    <div class="question" id="commercial-type" style="display: block;">
        ...
        <div class="answers">
            <div class="answer" data-type="radio" data-set="type:radio" data-show="radio-type">Radio</div>
            <div class="answer" data-type="tv" data-set="type:tv" data-show="tv-type">Television</div>
            <div class="answer" data-type="psa" data-set="type:psa" data-show="psa-type">Public Service Announcement</div>
        </div>
    </div>
    ...
    <div class="question" id="tv">
        ...
        <input type="number"  name="principal_actor" value="0">
        <h4>How many general extras do you need?</h4>
        <input type="number"  name="extra_actor" value="0">
        <h4>How many wardrobe fittings do you need?</h4>
        <input type="number"  name="wardrobe_fittings" value="0">
    </div>
    <div class="question" id="radio">
        <h4>How many actor/announcer do you need?</h4>
        <input type="number"  name="radio_actor" value="0">
        <h4>How many singer(s) do you need?</h4>
        <input type="number"  name="radio_singer" value="0">
        <h4>How many versions of the script do you need?</h4>
        <input type="number"  name="scripts" value="1">
        <h4>How many tags do you need?</h4>
        <input type="number"  name="radio_tags" value="0">
    </div>
    <div class="question" id="psa">
        <h4>How many actor/announcer do you need?</h4>
        <input type="number"  name="psa_actor" value="0">
        <h4>How many singer(s) do you need?</h4>
        <input type="number"  name="psa_singer" value="0">
        <h4>How many versions of the script do you need?</h4>
        <input type="number"  name="scripts" value="1">
    </div>
    <div class="totals">
            <div class="detailed">
                <div class="actions">
                    ...
                    <a href="#"><i class="fas fa-print"></i> Print this estimate</a>
                </div>
