...
class FalconEstimator {
    ...
    public function frontend_scripts() {
        ...
        if ($post->ID == $page) {
            ...
            //wp_enqueue_script('fpe-tex-autocomplete', plugin_dir_url(__FILE__).'/autocomplete/js/textext.plugin.autocomplete.js', array('fpe-text-core'));
            //wp_enqueue_script('fpe-tex-filter', plugin_dir_url(__FILE__).'/autocomplete/js/textext.plugin.filter.js', array('fpe-text-core'));
            //wp_enqueue_script('fpe-tex-tags', plugin_dir_url(__FILE__).'/autocomplete/js/textext.plugin.tags.js', array('fpe-text-core'));
            wp_enqueue_script('fpe-scripts', plugin_dir_url(__FILE__).'/frontend.js', array('jquery'));
            wp_enqueue_style('fpe-styles', plugin_dir_url(__FILE__).'/frontend.css');    
            //wp_enqueue_style('fpe-autocomplete-styles', plugin_dir_url(__FILE__).'/autocomplete/tagify.css');    
            //wp_enqueue_style('fpe-text-core', plugin_dir_url(__FILE__).'/autocomplete/css/textext.plugin.autocomplete.css');    
            //wp_enqueue_style('fpe-text-core', plugin_dir_url(__FILE__).'/autocomplete/css/textext.plugin.tags.css');    
        }
    }
